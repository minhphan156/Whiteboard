...
public class DText extends DShape {
    ...
    public void draw(Graphics g)
    {
        ...
        Rectangle2D rect = fm.getStringBounds(textModel.getText(), g2);
        ...
        g2.drawString(textModel.getText(),textX,textY);
    ...
    public Font computeFont(){
        ...
        Font finalFont = new Font(textModel.getFontNameModel(),Font.LAYOUT_LEFT_TO_RIGHT,finalSize);
